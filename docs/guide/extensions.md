...
In this architecture, we identify Jobs as being part of the business logic layer
...
The GraphQL layer of the Rails app is similar to the controller and view layers:
